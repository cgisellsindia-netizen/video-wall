  ...
  return (
    <footer className="footer">
      <div className="footer-inner">
        ...
        <div className="footer-col"><h4>Support</h4><a href="/install">Installation</a><a href="/returns-policy">Returns Policy</a><a href="/terms-of-service">Terms of Service</a><a href="/privacy-policy">Privacy Policy</a><a href="/contact">Contact Us</a></div>
